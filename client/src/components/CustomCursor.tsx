...
/**
 * Soft blue-halo cursor: the native cursor stays visible, and a faint glow
 * lerps after it as ambient theming. On interactive elements the halo expands
 * and brightens. Disabled on touch devices.
