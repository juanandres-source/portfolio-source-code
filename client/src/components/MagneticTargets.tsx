 ...
 * `data-magnetic` a soft pull toward the cursor when hovered.
 * Translation is applied via CSS variables --mag-x / --mag-y.
...
export default function MagneticTargets() {
  useEffect(() => {
    ...
    const STRENGTH = 0.30; // fraction of cursor offset applied
    const MAX = 12;        // px — clamp so big buttons don't slide off
